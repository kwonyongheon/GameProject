...
namespace Minimalist.MapBuilder
{
    ...
    public class MapBuilder : MonoBehaviour
    {
        ...
        private void InstantiateBase()
        {
            ...
            // 货肺款 赣萍府倔 积己
            Material newBaseMaterial = new Material(Shader.Find("Standard"));
            newBaseMaterial.color = baseColor;

            basePrefab.GetComponent<Renderer>().sharedMaterial = newBaseMaterial;
        ...
        public void InstantiateTile(Vector3 position)
        {
            ...
            // 货肺款 赣萍府倔 积己
            Material newTileMaterial = new Material(Shader.Find("Standard"));
            newTileMaterial.color = tileColor;

            tilePrefab.GetComponent<Renderer>().sharedMaterial = newTileMaterial;
